...
The current results are estimated to match your intent by **approximately 95%**. Please let me know if you need additional data sourcing.`
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 font-sans">
      <Navbar />
      
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-200/50 dark:border-slate-800/50 overflow-hidden min-h-[80vh] flex flex-col">
            
            {/* Header Area - Enhanced */}
            <div className="p-8 pb-6 bg-gradient-to-r from-indigo-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex-shrink-0 z-20 border-b border-slate-200/50 dark:border-slate-800/50">
