...
export const RESOURCES: Resource[] = [
  // Analysis
  {
    ...
    image: "global_connectivity_cover",
  ...
  // Consulting
  {
    ...
    image: "industrial_factory_cover",
